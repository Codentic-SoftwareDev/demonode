module.exports = () => {
   ...
   * components:
   *  schema:
   *    camp-lejeune-water-contamination-add:
   *      type: object
   *      properties:
   *        status:
   *          type: string
   ...
   *        status: SUCCESS
   *        statusCode: 200
   *        message: camp-lejeune-water-contamination list found.
   *        data:
   ...
   *    post:
   *      summary: Add camp lejeune water contamination detail.
   ...
   *            application/json:
   *              schema:
   *                $ref: "#/components/schema/camp-lejeune-water-contamination-add"
   *        422:
