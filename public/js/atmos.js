(function ($) {
  ...
  $(document).on(
    "mouseenter",
    "body:not(.sidebar-pinned) .admin-sidebar",
    function (e) {
      if (windowWidth >= 1200) {
  ...
  $(document).on(
    "click",
    " .admin-close-sidebar ,.sidebar-backdrop",
    function (e) {
      e.preventDefault();
...
(function ($) {
  $.fn.alertNotify = function (options) {
    ...
    this.find(".alert-container").append(
